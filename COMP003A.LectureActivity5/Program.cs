...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Summation: {sum}"); // output the value of the sum to console 

            // if you don't plan on using a variable, you can simplify the methodcall like the lines below
         ...
         * if you typr '///' on top of a close or method,
         ...
         * <param name="namewOfTheParameter"></param> used for describing one or more parameters in the method signature 
        ...
        /// <summary>
        /// Method for suctracting two numeric variables
        /// </summary>
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal input</param>
        ...
        static decimal Multiply(decimal nnum1, decimal num2)
        {
            return nnum1 * num2;
        }
        ...
        /// <param name="counter".Integer input useed as a looping counter</param>
